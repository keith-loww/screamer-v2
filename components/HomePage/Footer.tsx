...
import { ActionIcon, Footer as ManatineFooter, Group } from '@mantine/core'
import Link from 'next/link'

export default function Footer() {
    return (
        <ManatineFooter height={60} className="p-4 flex justify-between items-center">
            <Group position='apart' className='w-full' >
                <div className="flex items-center space-x-2">
                    ...
                    <p>SCREAMER V2 - All rights reserved</p>
                </div>
                <div className="justify-self-end">
                    <Link href="https://www.github.com/keith-loww">
                        <ActionIcon>
                            <BsGithub size="24"/>
                        </ActionIcon>
                    </Link>
